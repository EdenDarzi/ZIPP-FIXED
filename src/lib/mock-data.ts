...
export const mockRestaurants: Restaurant[] = [
  {
    id: 'restaurant1',
    name: 'restaurant.name.pizzaPalace', 
    description: 'restaurant.desc.pizzaPalace', 
    imageUrl: 'https://placehold.co/800x600.png',
    dataAiHint: 'pizza italian',
    location: 'רחוב ראשי 123, אבן יהודה', 
    cuisineType: 'restaurant.cuisine.italian', 
    rating: 4.5,
  ...
  {
    id: 'restaurant2',
    name: 'restaurant.name.burgerBonanza', 
    description: 'restaurant.desc.burgerBonanza', 
    imageUrl: 'https://placehold.co/800x600.png',
    dataAiHint: 'burger american',
    location: 'שדרות האלון 456, אבן יהודה', 
    cuisineType: 'restaurant.cuisine.american', 
    rating: 4.2,
  ...
  {
    id: 'restaurant3',
    name: 'restaurant.name.pastaPerfection', 
    description: 'restaurant.desc.pastaPerfection', 
    imageUrl: 'https://placehold.co/800x600.png',
  ...
  {
    id: 'restaurant4',
    name: 'restaurant.name.saladSensations', 
    description: 'restaurant.desc.saladSensations', 
    imageUrl: 'https://placehold.co/800x600.png',
    dataAiHint: 'salad healthy',
    location: 'דרך המייפל 101, אבן יהודה', 
    cuisineType: 'restaurant.cuisine.healthy', 
    rating: 4.0,
  ...
  {
    id: 'florist1',
    name: 'restaurant.name.seasonalFlowers',
    description: 'restaurant.desc.seasonalFlowers',
    imageUrl: 'https://placehold.co/800x600.png',
    dataAiHint: 'flowers bouquets',
    location: 'שדרות הפרחים 5, עיר הגנים',
    cuisineType: 'restaurant.cuisine.flower',
    rating: 4.9,
