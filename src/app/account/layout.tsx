...
export default function AccountLayout({ children }: { children: ReactNode }) {
  ...
  const accountNavItems = [
    { href: '/account/profile', label: t('account.personalProfile'), icon: User },
    { href: '/account/addresses', label: t('account.manageAddresses'), icon: MapPin },
    { href: '/account/payment-methods', label: t('account.paymentWallet'), icon: Wallet },
    { href: '/account/order-history', label: t('account.orderHistory'), icon: ListOrdered },
    { href: '/account/security', label: t('account.securityAlerts'), icon: Shield },
  ];
    ...
    <div className="container mx-auto py-8">
      <div className="md:grid md:grid-cols-12 md:gap-8">
        <aside className="md:col-span-3 lg:col-span-2 mb-8 md:mb-0">
          <h2 className="text-xl font-semibold mb-4 text-primary">{t('account.myAccount')}</h2>
