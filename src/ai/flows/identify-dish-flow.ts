...
2.  **Provide General Suggestion for User ('generalSuggestion'):**
    *   Compose a helpful response for the user. This should address their query (if any).
...
3.  **Provide Business Opportunity Insight (IF 'isTrend' is true and significant, populate 'businessOpportunity'):**
    *   If you identify a significant, actionable trend, populate the 'businessOpportunity' object. This is for businesses on SwiftServe.
    ...
    *   'suggestedTags': Provide 2-3 relevant tags (e.g., "New", "TikTok Famous", "Spicy Challenge", "Limited Time", "Customer Inspired").
    *   'rationale': Briefly explain why this trend could be a good opportunity for a local business on SwiftServe (e.g., "High user engagement in this category," "Viral potential," "Fills a gap in current local offerings," "Easy to adapt for existing kitchens").
...
Example Output (Significant TikTok Trend, no user query):
{
  ...
  "isTrend": true,
  "trendSource": "TikTok",
  "generalSuggestion": "Wow, these look like the super trendy Spicy Honey Butter Chicken Wings taking over TikTok! This dish is known for its incredible sweet, savory, and spicy flavor combination. For a similar fiery and sweet kick on SwiftServe, try searching for 'Korean Fried Chicken with Honey Glaze' at 'Seoul Food Express' or explore our 'Wings World' category.",
  "businessOpportunity": {
    "suggestedItemName": "SwiftServe Fiery Honey Wings",
    "suggestedPriceRange": "₪35-₪45",
    "suggestedDescription": "Crispy chicken wings tossed in our signature spicy honey butter glaze. A viral sensation you can now try, inspired by top TikTok trends!",
    "suggestedTags": ["New", "TikTok Viral", "Spicy & Sweet", "Customer Inspired"],
    "rationale": "This wing flavor profile is highly shared on social media and shows strong user interest. Offering a unique version could attract significant attention and ride the viral wave."
  }
}
...
Example Output (General dish, user query "Is this healthy?"):
{
  ...
  "isTrend": false,
  "generalSuggestion": "This appears to be a Quinoa Salad with Roasted Vegetables. It's generally a healthy and balanced choice, rich in fiber and protein! On SwiftServe, you can find many healthy salad options by searching for 'grain bowls' or 'roasted veggie salads' under our 'Healthy Eats' tag.",
} 
